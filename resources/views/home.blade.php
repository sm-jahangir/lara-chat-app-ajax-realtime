                                        ...
                                        <tbody>
                                            @foreach ($users as $key => $value)
                                                <tr>
                                                    ...
                                                    <td>{{ $value->email }}</td>
                                                    <td>
                                                        <button class="btn btn-success btn-sm startChat"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="input-group">
                        ...
                        <input id="sendAuthID" value="{{ Auth::user()->id }}" type="hidden">
                        <textarea id="message" class="form-control" placeholder="Enter message here . . ."
                            aria-label="Enter message here . . ." aria-describedby="basic-addon2"></textarea>
...
@push('js')
    <script>
        ...
        function renderList(getUserSendToId, sendToAuthID) {
            jQuery.ajax({
                url: "{{ route('renderConversationList') }}",
                method: 'post',
                data: {
                    getUserSendToId: getUserSendToId,
                    sendToAuthID: sendToAuthID
                },
